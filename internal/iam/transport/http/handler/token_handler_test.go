...
func (s *stubTokenHandlerService) IssueAfterLogin(ctx context.Context, user *entity.User, device *entity.Device) (*iam_domainsvc.TokenResult, error) {
	return &iam_domainsvc.TokenResult{}, nil
}
func (s *stubTokenHandlerService) IssueForMFA(ctx context.Context, userID, deviceID string) (*iam_domainsvc.TokenResult, error) {
	return &iam_domainsvc.TokenResult{}, nil
}
func (s *stubTokenHandlerService) Rotate(ctx context.Context, req *iam_domainsvc.RotateRequest) (*iam_domainsvc.TokenResult, error) {
	if s.rotateErr != nil {
...
func TestTokenHandlerRefreshMapsUnboundDeviceToUnauthorized(t *testing.T) {
	...
	logger.InitLogger()
	h := NewTokenHandler(&stubTokenHandlerService{rotateErr: iam_errorx.ErrRefreshDeviceUnbound})
...
func TestTokenHandlerRefreshSetsCookiesOnly(t *testing.T) {
	gin.SetMode(gin.TestMode)
	logger.InitLogger()
	h := NewTokenHandler(&stubTokenHandlerService{
		rotateResult: &iam_domainsvc.TokenResult{
