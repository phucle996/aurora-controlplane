...
func (s *stubTokenService) IssueAfterLogin(ctx context.Context, user *entity.User, device *entity.Device) (*iam_domainsvc.TokenResult, error) {
	if s != nil {
...
func (s *stubTokenService) IssueForMFA(ctx context.Context, userID, deviceID string) (*iam_domainsvc.TokenResult, error) {
	return &iam_domainsvc.TokenResult{}, nil
}

func (s *stubTokenService) Rotate(ctx context.Context, req *iam_domainsvc.RotateRequest) (*iam_domainsvc.TokenResult, error) {
	return &iam_domainsvc.TokenResult{}, nil
}
