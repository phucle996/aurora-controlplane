...
export default function UserMetaCard({
  ...
  }, [avatarURL, company, country, fullName, isOpen, jobFunction]);
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              {avatarURL !== "" ? (
                ...
                <div className="flex h-full w-full items-center justify-center bg-brand-500/10 text-lg font-semibold text-brand-600 dark:text-brand-400">
                  {initials}
                </div>
              )}
            </div>
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {country || company || "No location set"}
                </p>
              </div>
            </div>
            <div className="order-2 grow xl:order-3 xl:text-right">
