...
import { getActor, logoutSession, subscribeSession } from "@/components/auth/auth-session";
...
export default function UserDropdown() {
  ...
  const [actor, setActor] = useState<Actor>(getActor());
  ...
  const displayName = fullName !== "" ? fullName : username !== "" ? username : "Guest";
  const displayEmail = email !== "" ? email : "Not signed in";
